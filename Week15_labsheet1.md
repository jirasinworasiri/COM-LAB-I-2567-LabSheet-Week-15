...
**บันทึกผลที่ได้**![image](https://github.com/user-attachments/assets/b018f825-5320-4827-9d3c-ea9c3e46f2f0)

 
20. กดปุ่ม Ctrl+F5 เพื่อรันในโหมดปกติ (ไม่ใช่ debug mode)

**บันทึกผลที่ได้**![image](https://github.com/user-attachments/assets/7af531de-c821-44c1-b845-b0a4243ac6a7)
