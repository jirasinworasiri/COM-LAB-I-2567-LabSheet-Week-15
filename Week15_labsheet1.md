...
**บันทึกผลที่ได้**![image](https://github.com/user-attachments/assets/01c637e1-16f1-4d95-aeea-504b27eac5b0)

 
20. กดปุ่ม Ctrl+F5 เพื่อรันในโหมดปกติ (ไม่ใช่ debug mode)

**บันทึกผลที่ได้**![image](https://github.com/user-attachments/assets/83057f40-1294-4ae0-b495-c771172fc7fc)
