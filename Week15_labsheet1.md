...
**บันทึกผลที่ได้**![image](https://github.com/user-attachments/assets/c011fe1b-19e7-49eb-97b6-e0e7e9fd9efb)

 
20. กดปุ่ม Ctrl+F5 เพื่อรันในโหมดปกติ (ไม่ใช่ debug mode)

**บันทึกผลที่ได้**![image](https://github.com/user-attachments/assets/dad38925-cbc8-473b-820b-671dfc318f93)
